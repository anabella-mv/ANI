...
\begin{itemize}
    ...
    \item \textbf{Interior de un polígono convexo:} Sea la intersección de los semiplanos abiertos determinados por las rectas $\overleftrightarrow{a_ia_{i+1}}$ que contienen a los demás puntos, en estos se ignora los lados del polígono.
\end{itemize}
Notar que en el caso del cuadrilátero $i=1,\dots,4$.\\\\

Sean $a_1, \dots, a_4$ los puntos que determinan un polígono convexo, entonces los lados del polígono están determinados por los segmentos $\overline{a_ia_{i+1}}$, considero la recta que contiene a $a_1$ y $a_3$, esta recta, divide el plano en dos semiplanos abiertos en los cuales $a_2$ y $a_4$ quedan en semiplanos distintos:\\\\
Si no fuese así, supongo a $a_2$ está unido a $a_1$ y $a_3$ mediante los lados $\overline{a_1a_2}$ y $\overline{a_2a_3}$, Por definición del interior del cuadrilátero, uno de sus semiplanos que los forman, es decir, $\overleftrightarrow{A}_B$, con  $A=\overrightarrow{a_1a_2}$ y $B=\overrightarrow{a_2a_3}$ contienen a $a_3$ y $a_4$
\end{document}