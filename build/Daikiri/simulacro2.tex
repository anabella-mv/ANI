...
\begin{enumerate}
    ...
    \end{figure}
    \begin{enumerate}
        \item Determinar el dominio, la imagen y los valores de las raíces de la función.
    ...
    \begin{enumerate}
        ...
        \item Determinar la ecuación de la recta $P$ que es perpendicular a la recta del inciso anterior que pasa por el punto $C=\left(\frac{3}{2},2\right)$
    ...
    \end{enumerate}
    \item Sabiendo que el gráfico de la función cuadrática $f(x)=ax^2+bx+\frac{5}{2}$ pasa por los puntos $M=\left(2,\frac{9}{2}\right)$ y $N=\left(-8,\frac{9}{2}\right)$
    \begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Encuentre las coordenadas $(x,y)$ del punto $P(t)$, $P(t+\frac{\pi}{3})$ y $P(t+\pi)$
