...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textit{r}: $\lnot (\exists x \in \mathbb{R} / x^2<0) \equiv \forall x \in \mathbb{R} , x^2\geq0$
    \end{itemize}
    ...
    \begin{enumerate}
        ...
        \item Determinar si los puntos $A=(-\frac{1}{9},\frac{1}{3})$ pertenece a la recta $L_2$ y si $B=(-\frac{1}{9},-2)$ pertenece a la recta $L_1$ y calcular la distancia entre los puntos $A$ y $B$.
    \end{enumerate}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.2]{Imagenes/edificio.png}
        \label{fig:punto9}
    \end{figure}
