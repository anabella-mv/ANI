...
\item \begin{enumerate}
    ...
    \item \begin{itemize}
        ...
        \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.4]{Imagenes/Acom.png}
        \label{fig:AC}
    \end{figure}
        \item $E=A \cup C = (-3,-1] \cup [1,\infty)$
        \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.4]{Imagenes/AUC.png}
        \label{fig:AUC}
    \end{figure}
        \item $F=A-C = (-3,-1]=A$
        \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.3]{Imagenes/AmenosC.png}
        \label{fig:AmenosC}
    \end{figure}
    \end{itemize}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.4]{Imagenes/parabola7.png}
        \label{fig:punto7}
    \end{figure}
    \end{enumerate}
...
\item \begin{enumerate}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.8]{Imagenes/CS.png}
        \label{fig:consejo}
    \end{figure}
    \item
    \begin{figure}[htb]
        \centering
        \includegraphics[scale=0.8]{Imagenes/CE.png}
        \label{fig:consejere}
    \end{figure}
\end{enumerate}
\end{enumerate}
