...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \begin{equation*}
            f(x)=\frac{2x}{x^2-1} - \frac{1}{x-1} = \frac{2x}{(x-1)(x+1)} - \frac{1}{x-1} = \frac{2x-(x+1)}{(x-1)(x+1)} = \frac{x-1}{(x-1)(x+1)} = \frac{1}{x+1}, x \neq 1
            \end{equation*}
    \end{enumerate}
...
\begin{enumerate}
    ...
    \begin{equation*}
        A: \frac{1}{3} = \frac{1}{3}(2) + 1= \frac{2+3}{3}=\frac{5}{3} \quad \textbf{No pertenece}
    \end{equation*}
    ...
    \begin{gather*}
        d = \sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2} = \sqrt{\left(-\frac{1}{9} - 2\right)^2 + (-2 - \frac{1}{3})^2} = \sqrt{\left(-\frac{19}{9}\right)^2 + \left(-\frac{7}{3}\right)^2}\\
         = \sqrt{\frac{361}{81} + \frac{189}{81}} = \sqrt{\frac{550}{81}} = \frac{\sqrt{550}}{9} = \frac{5\sqrt{22}}{9}
    \end{gather*}
\end{enumerate}
...
\begin{itemize}
    ...
    \end{equation*}
    Sabiendo la altura del edificio, podemos usar el segundo triángulo para encontrar la distancia entre las plazas:
