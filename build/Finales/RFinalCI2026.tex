...
\begin{enumerate}
    ...
    \item Resolución:
    \begin{gather*}
        \frac{2026^2-2024^2}{2026+2024}+\left(\left(\frac{9}{2}-i2\right)+\left(\overline{\frac{9}{2}-i2}\right)\right)\cdot 3^{-2} - \sqrt[16]{\left(\frac{2^4\cdot 3}{15 \cdot 5^2 \cdot 5^{-3}}\right)^4}=\\
        \frac{(2026-2024)(2026+2024)}{2026+2024}+\left(\left(\frac{9}{2}-i2\right)+\left(\frac{9}{2}+i2\right)\right)\cdot \frac{1}{3^2} - \sqrt[16]{\left(\frac{2^4\cdot 3}{3 \cdot 5 \cdot 5^2 \cdot 5^{-3}}\right)^4}=\\
        2+\left(\left(\frac{9}{2}+\frac{9}{2}+i2-i2\right)\right)\cdot \frac{1}{9} - \left(\frac{2^4\cdot 3}{3 \cdot 5^3 \cdot 5^{-3}}\right)^{\frac{4}{16}}=\\
