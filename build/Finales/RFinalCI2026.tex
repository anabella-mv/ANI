...
\begin{enumerate}
    ...
    \item Resolución:
    \begin{gather*}
        \frac{2026^2-2024^2}{2026+2024}+\left(\left(\frac{9}{2}-2i\right)+\left(\overline{\frac{9}{2}-2i}\right)\right)\cdot 3^{-2} - \sqrt[16]{\left(\frac{2^4\cdot 3}{15 \cdot 5^2 \cdot 5^{-3}}\right)^4}=\\
        \frac{(2026-2024)(2026+2024)}{2026+2024}+\left(\left(\frac{9}{2}-2i\right)+\left(\frac{9}{2}+2i\right)\right)\cdot \frac{1}{3^2} - \sqrt[16]{\left(\frac{2^4\cdot 3}{3 \cdot 5 \cdot 5^2 \cdot 5^{-3}}\right)^4}=\\
        2+\left(\left(\frac{9}{2}+\frac{9}{2}+2i-2i\right)\right)\cdot \frac{1}{9} - \left(\frac{2^4\cdot 3}{3 \cdot 5^3 \cdot 5^{-3}}\right)^{\frac{4}{16}}=\\
        2+\left(\left(\frac{18}{2}+0\right)\right)\cdot \frac{1}{9} - \left(\frac{2^4}{1}\right)^{\frac{1}{4}}=\\
        2+9\cdot \frac{1}{9}-2=\\
        2+1-2=1
    \end{gather*}
    %Punto 2
    ...
    \item 
    \begin{enumerate}
        \item El conjunto $A$ se puede expresar como el intervalo $[3,8]$, el conjunto $B$ por extensión es $\varnothing$ pues el conjunto universal sólo llega a 8 y $C$ se puede expresar por compresión como $\{x \in \mathcal{U}/ x<7\}$.
        \item 
        \begin{enumerate}
            ...
            \begin{figure}[H]
            \centering
            \includegraphics[scale=0.5]{Imagenes/D.png}
            \end{figure}
            \item $E=A \cap C=[3,7)$
            Representación en Diagrama de Venn:
            \begin{figure}[H]
            ...
            \begin{figure}[H]
            \centering
            \includegraphics[scale=0.5]{Imagenes/E.png}
            \end{figure}
            \item $F=A-C=[7,8]$
            Representación en Diagrama de Venn:
            \begin{figure}[H]
            ...
            \begin{figure}[H]
            \centering
            \includegraphics[scale=0.5]{Imagenes/F.png}
            \end{figure}
        \end{enumerate}
    \end{enumerate}
