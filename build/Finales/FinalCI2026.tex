...
\begin{enumerate}
    ...
    \textit{Nahuel encargó nuevos stickers de cada carrera de FAMAF, como compró por plantillas y sin recortar, Franco quiere saber de cuantos stickers son cada plantilla para ver si se necesita más ayuda para recortarlos. Nahuel sabe que en total pidió 66 stickers por carrera y de los cuales vienen 3 plantillas grandes y 2 pequeñas y también que el local al que encargó tiene promos de 25 stickers por 1 plantilla grande y 1 plantilla pequeña.}
    \begin{enumerate}
        \item Escribir el sistema de ecuaciones que representa la situación.
        \item Utilizando alguno de los métodos de igualación, sustitución o reducción, resolver el sistema de ecuaciones para encontrar cuantos animales había de cada especie.
    \end{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Determinar si los puntos $A=(\frac{1}{2},\frac{4}{3})$ pertenece a la recta $L_2$ y si $B=(\frac{2}{3},\frac{4}{3})$ pertenece a la recta $L_1$ y calcular la distancia entre los puntos $A$ y $B$.
    \end{enumerate}

    %Punto 7: Parábolas.
    \item Sea la parábola $P: y = 2x^2+bx-16$ que tiene eje de simetría en $x=\frac{7}{2}$.
    \begin{enumerate}
    ...
    \begin{enumerate}
        \item Actualemnte la conduccion del CEIMAF la tiene el guri, como esta compuesto el CEIMAF?
        \begin{itemize}
